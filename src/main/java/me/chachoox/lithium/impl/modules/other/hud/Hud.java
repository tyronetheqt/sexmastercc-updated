...
public class Hud extends Module {
    ...
    public String getWatermark() {
        final String WATERMARK = TextColor.DARK_PURPLE + "[" + TextColor.LIGHT_PURPLE + "SquidwardHack.EU" + TextColor.DARK_PURPLE + "] ";
        final String RAINBOW_MARK = rainbow.getValue().getColor() + "[SquidwardHack.EU] ";
