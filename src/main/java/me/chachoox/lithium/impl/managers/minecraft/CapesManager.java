...
public class CapesManager extends SubscriberImpl {
    ...
    private static final String[] USOMI_UUIDS = {
            "3daf3d9d-629f-49f9-bc19-a86e0b6f125b"
    };
    ...
    private static final ResourceLocation USOMI_CAPE = new ResourceLocation("lithium/textures/capes/cpvcape.png");
    ...
    public static ResourceLocation getResourceLocation(UUID id) {
        ...
        for (String string : USOMI_UUIDS) {
            if (string.equalsIgnoreCase(stringId)) {
                return USOMI_CAPE;
            }
        }
        for (String string : NOM_UUIDS) {
            if (string.equalsIgnoreCase(stringId)) {
                return NOM_CAPE;
            }
        }
