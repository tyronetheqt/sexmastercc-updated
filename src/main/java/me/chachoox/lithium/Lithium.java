...
@Mod(name = "SquidwardHack", modid = "squidwardhack", version = Lithium.VERSION)
public class Lithium {
    public static final String NAME = "SquidwardHack";
    public static final String VERSION = "v0.5.7";
    public static final File DIRECTORY = new File(Minecraft.getMinecraft().gameDir.getAbsolutePath(), "squidwardhack");
    ...
    public static void load() {
        ...
        Logger.getLogger().log(Level.INFO, "\"rape\"");
        Logger.getLogger().log(Level.INFO, "grog.solutions soon™");
    }
}
